...
public class StudentDTO {
    ...
    public StudentDTO(String studentId, String fName, String mName, String lName, String address, String parentName, String contactNo, LocalDate dob, int age, String gender, String email, String province, List<ProgramDTO> programList) {
        this.studentId = studentId;
        this.fName = fName;
        this.mName = mName;
        this.lName = lName;
